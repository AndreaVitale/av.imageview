...
namespace titanium {
	namespace bindings {
		...
		BindEntry* ImageviewAndroidBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				...
				{"av.imageview.ImageViewModule", ::av::imageview::ImageViewModule::bindProxy, ::av::imageview::ImageViewModule::dispose}
			};
